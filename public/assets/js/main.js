    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.deposit-wrap .dropdown-item', function () {
            ...
            if ($(this).data('id') == 'balance') {
                ...
                $('#exchange').remove();
                $('#wallet').remove();
                $('.deposit-block').append('<button type="button" class="btn2" id="wallet">Deposito</button>');
                type = 'balance';
        ...
        // AQUI ADICIONEI FUNÇÕES PARA ABRIR POP-UP


        $("#abrirSaque").click(function(){
                                
            $("#walletModal").modal('show'); // Abrir o pop-up deposito
        });

        $("#abrirDeposito").click(function () {
            var target = $(this).data('target');
            $(".btn-tab").removeClass('isActive');
            $(".btn-tab[data-type='" + target + "']").addClass('isActive');
            $(".deposit-section").hide();
            $(".deposit-section[data-type='" + target + "']").show();
            abrirModal();
        });
    
        $("#abrirDeposito2").click(function () {
            var target = $(this).data('target');
            $(".btn-tab").removeClass('isActive');
            $(".btn-tab[data-type='" + target + "']").addClass('isActive');
            $(".deposit-section").hide();
