    ...
    <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
        ...
        >
            <div>
                ...
                @if ($sidebar->getTitle() || $sidebar->getDescription())
                ...
                {{-- Sidebar Groups --}}
                <ul class="@if ($sidebar->getTitle() || $sidebar->getDescription()) mt-4 @endif space-y-2 font-inter font-medium" wire:ignore>
